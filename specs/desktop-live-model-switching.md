...
- An unresolved Auto draft renders only `Auto` in the status bar; it does not render `off`, `auto`, or another placeholder thinking label before the router chooses a tier.
