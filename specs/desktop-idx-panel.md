...
- Overview refresh is best-effort and periodic while the panel is idle. Query/inspect controls are disabled until IDX is available and the project is initialized.
