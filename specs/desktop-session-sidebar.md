...
- The inspector is a connected workbench pane with compact rows and separators rather than nested cards. At normal widths it consumes a fixed auxiliary region; below the narrow-window breakpoint it overlays the right edge of the workspace instead of shrinking the transcript further.
