...
> **Исторический документ.** Этот roadmap описывает sidecar/legacy-совместимую
> архитектуру на базовой ревизии `6bd426c` и сохранён как evidence прежних
> решений. Текущая реализация сделала clean break: только новые journal-сессии,
> без DCP sidecar, migration adapters и `decompress/recompress`. Актуальное
> поведение задают `03-dcp.md`, `26-dcp-provider-cache-stability.md` и план 32;
> пункты ниже не являются требованиями вернуть удалённый compatibility-код.
