...
- Confirmed by code: `SettingsPanel.svelte` blocks save while `settingsSourceIssues` reports problems and replaces drafts with the document returned by `write_user_config`.
