...
export const EXTENSION_EVAL_COVERAGE: Record<string, EvalCoverageEntry> = {
	...
	"repo-discovery": { deterministic: ["test/repo-discovery.test.ts", "test/repo-native-compact.test.ts", "test/tool-descriptions.test.ts"], live: ["tool.semantic-repo-search", "tool.architecture-first", "tool.repo-ask", "tool.repo-context", "tool.repo-audit"] },
...
export const TOOL_EVAL_COVERAGE: Record<string, EvalCoverageEntry> = {
	...
	repo_structure: { deterministic: ["test/repo-discovery.test.ts", "test/repo-native-compact.test.ts"] },
	repo_ast: { deterministic: ["test/repo-discovery.test.ts", "test/repo-native-compact.test.ts"] },
	repo_search: { deterministic: ["test/repo-discovery.test.ts", "test/repo-native-compact.test.ts"], live: ["tool.semantic-repo-search"] },
	repo_explain: { deterministic: ["test/repo-discovery.test.ts", "test/repo-native-compact.test.ts"] },
	repo_deps: { deterministic: ["test/repo-discovery.test.ts", "test/repo-native-compact.test.ts"] },
	repo_ask: { deterministic: ["test/repo-discovery.test.ts", "test/tool-descriptions.test.ts"], live: ["tool.repo-ask"] },
	repo_context: { deterministic: ["test/repo-discovery.test.ts", "test/tool-descriptions.test.ts"], live: ["tool.repo-context"] },
