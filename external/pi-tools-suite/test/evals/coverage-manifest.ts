...
export const EXTENSION_EVAL_COVERAGE: Record<string, EvalCoverageEntry> = {
	...
	"repo-discovery": { deterministic: ["test/repo-discovery.test.ts", "test/repo-native-compact.test.ts", "test/tool-descriptions.test.ts"], live: ["tool.semantic-repo-search", "tool.architecture-first", "tool.repo-context-general", "tool.repo-context", "tool.repo-audit"] },
