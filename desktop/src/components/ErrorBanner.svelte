...
<div class="row-start-1 mx-[22px] mt-2.5 flex items-center gap-2.5 rounded-md border border-destructive/35 bg-destructive/5 px-3 py-2 text-xs text-destructive" role="alert">
